...
import { sendAdminNotification, formatRegistrationMsg } from '../../services/telegramService.ts';
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col p-8">
      <div className="mt-8 mb-8 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 mt-2 text-sm">আপনার ইমেইলে পাঠানো কোডটি নিচে দিন</p>
      </div>
