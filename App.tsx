...
// Fix: Adjusted path to constants.tsx located in pages/user/
import { NAV_ITEMS } from './pages/user/constants.tsx';

// Pages
// Fix: Corrected import paths based on provided file locations. 
// User login and OTP pages were provided in pages/admin/ despite being user-facing.
import LoginPage from './pages/admin/LoginPage.tsx';
import RegisterPage from './pages/auth/RegisterPage.tsx';
import OtpPage from './pages/admin/OtpPage.tsx';
...
// Admin Pages
// Fix: Corrected paths for Admin Dashboard and Login components.
